      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-12">
        ...
        <div className="mt-16 flex gap-12">
          <div className="min-w-0 flex-1 space-y-8">
            <div id="essentiel" className="scroll-mt-24 rounded-2xl border border-accent/20 bg-gradient-to-br from-accent/5 to-primary/5 p-8 shadow-md sm:p-10">
            ...
            <Section title="Données collectées" id="donnees">
            ...
            <Section title="Cookies et traceurs" id="cookies">
              <p>
            ...
            <Section title="Liens d'affiliation" id="affiliation">
              <p>
            ...
            <Section title="Vos droits" id="droits">
              <p>
            ...
            <Section title="Sécurité" id="securite">
              <p>
            ...
            <Section title="Modifications de cette politique" id="modifications">
              <p>
