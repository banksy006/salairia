  ...
  const jsonLd = [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "SASU / EURL", item: `${SITE_URL}/simulateurs/sasu-eurl` },
      ],
    },
  ];
              ...
              <section id="sources" className="scroll-mt-24">
                <div className="rounded-2xl border border-border bg-white p-6 shadow-md sm:p-8">
                  ...
                  <p className="mt-6 text-xs italic text-muted-foreground">
                    Dernière mise à jour : septembre 2026. Estimation simplifiée basée sur des taux moyens. Les cotisations TNS réelles dépendent du niveau de revenu (taux progressifs). Les cotisations SASU dépendent de la convention collective. Pour une optimisation précise, consultez un expert-comptable.
                  </p>
                </div>
              </section>
            </div>
